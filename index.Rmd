...
dvc_sd %>%
  ...
  addAwesomeMarkers(
    icon = awesomeIcons(
      ...
      text = case_when(
        dvc_2017$inc_month == 1 ~ "JAN",
        dvc_2017$inc_month == 2 ~ "FEB",
        dvc_2017$inc_month == 3 ~ "MAR",
        dvc_2017$inc_month == 4 ~ "APR",
        dvc_2017$inc_month == 5 ~ "MAY",
        dvc_2017$inc_month == 6 ~ "JUN",
        dvc_2017$inc_month == 7 ~ "JUL",
        dvc_2017$inc_month == 8 ~ "AUG",
        dvc_2017$inc_month == 9 ~ "SEP",
        dvc_2017$inc_month == 10 ~ "OCT",
        dvc_2017$inc_month == 11 ~ "NOV",
        dvc_2017$inc_month == 12 ~ "DEC",
        TRUE ~ "NA"
        )
    ),
    popup = ~paste0(
